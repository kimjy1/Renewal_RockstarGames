...
const textbox1 = document.querySelector(".asidewrapbox1");
const textbox2 = document.querySelector(".asidewrapbox2");
const textbox3 = document.querySelector(".asidewrapbox3");
